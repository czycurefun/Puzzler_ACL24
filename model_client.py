...
DEFAULT_API_KEY_FILE = os.environ.get(
    "IJBR_API_KEY_FILE",
    "/home/public/minzhi/code/llm_judge_pressure_risk_sessions.py",
)
...
def call_chat_completion(
    ...
    if not api_key:
        raise ValueError("Missing API key. Set ANTCHAT_API_KEY or IJBR_API_KEY_FILE.")
    ...
    return {"ok": False, "content": "", "error": last_error or "unknown request error"}
